# WARNING: This repository is going to be archived.
# The package is being moved to https://github.com/Rishabh5321/custom-packages-flake
# Please visit that repository for future updates and support.

{
  description = "DEPRECATED: Thorium Nix Flake - Moved to https://github.com/Rishabh5321/custom-packages-flake";
  inputs.nixpkgs.url = "github:nixos/nixpkgs/nixos-unstable";

  outputs = { self, nixpkgs, ... }:
    let
      warningMessage = "WARNING: This repository (thorium-flake) is being archived. Please move to https://github.com/Rishabh5321/custom-packages-flake for future updates.";
    in
    {
      packages.x86_64-linux = builtins.trace warningMessage (
        let
      ...
      apps.x86_64-linux = builtins.trace warningMessage (
        let
